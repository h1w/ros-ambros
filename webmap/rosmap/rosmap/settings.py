"""
Django settings for rosmap project.
...
REPOSITORY_DIR = Path(__file__).resolve().parent.parent.parent.parent
...
WSGI_APPLICATION = 'rosmap.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': secret_credentials.database['ra_db']['ENGINE'],
        'NAME': secret_credentials.database['ra_db']['NAME'],
